    ...
    <div class="container" style="margin-top: 30px">
      <div class="row">
        <div class="col-md-4 col-sm-12 col-lg-3">
          ...
          />
          <br>
          <vue-typer class="headline" :style="{fontSize: '2.2rem!important'}" :repeat="0" text="Raihan Kabir" ></vue-typer>
          <br>
          <vue-typer
            :text="titles"
            :repeat="Infinity"
            ...
            <div class="mt-5">
              ...
              >
                <div>
                  ...
                  <strong style="color: green">Others</strong> ➞ Linux, Gunicorn, Supervisor, Nginx, Apache, Virtual Environment, Git, CI-CD<br><br>
